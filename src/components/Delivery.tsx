...
export default function Delivery() {
  ...
  const deliveryCharge =
    selectedArea.km === 0 ? 0 : selectedArea.km <= 5 ? 0 : (selectedArea.km - 5) * 15;
  ...
  return (
    <section id="delivery" className="bg-[#111111] text-white py-28 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div className="bg-black border border-orange-500/20 rounded-[40px] p-8 shadow-2xl">
            ...
            <div className="space-y-5 max-h-[650px] overflow-y-auto pr-2">
              {deliveryItems.map((item) => (
                <div
                  key={item.name}
                  className="bg-white text-black p-5 rounded-3xl flex items-center justify-between gap-5"
                >
                  <div>
                  ...
                  {(cart[item.name] || 0) === 0 ? (
                    <button
                      ...
                      className="bg-black text-white px-6 py-3 rounded-2xl font-black"
                    >
                      ADD +
                    </button>
                  ) : (
                    <div className="flex items-center gap-5 bg-black text-white px-5 py-3 rounded-2xl">
                      <button
          ...
          <div className="bg-orange-500 text-black rounded-[40px] p-10 shadow-2xl">
            <h3 className="text-5xl font-black">
              Delivery Order
            </h3>

            <label className="block mt-10 text-xl font-black">
            ...
            <select
              ...
              className="w-full mt-4 p-5 rounded-2xl text-xl font-bold outline-none"
            >
              {areas.map((area) => (
            ...
            {totalItems === 0 && (
              <div className="bg-black text-white rounded-[35px] p-8 mt-10">
                <p className="text-xl">
            ...
            {canShowBill && (
              <>
                <div className="bg-black text-white rounded-[35px] p-8 mt-10 space-y-5">
                  ...
                  <div className="border-t border-white/20 pt-5 space-y-4">
                    ...
                    <div className="border-t border-white/20 pt-5 flex justify-between text-3xl font-black text-orange-400">
                      <span>Total</span>
                ...
                <div className="mt-10">
                  ...
                  <div className="grid grid-cols-2 gap-5 mt-6">
                    <button
                      ...
                      className={`p-5 rounded-2xl font-black text-lg ${
                ...
                {paymentMethod === "Online UPI" && (
                  <div className="bg-white rounded-[35px] p-8 mt-10 text-center">
                    <h3 className="text-3xl font-black">
                      Scan & Pay
                    </h3>
                    ...
                    <img
                      ...
                      alt="UPI QR"
                      className="mx-auto mt-8 rounded-3xl border-4 border-black"
                    />
                    ...
                    <button
                      ...
                      className="w-full mt-8 bg-green-500 text-black py-5 rounded-2xl text-xl font-black"
                    >
                      Payment Completed
                    </button>

                    {paymentDone && (
                      <p className="text-green-700 text-2xl font-black mt-5">
                        Payment Successful ✓
                      </p>
                    )}
                  </div>
